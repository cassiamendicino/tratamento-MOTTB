...
#### IMPORTAÇÃO 
SIMC_bruto<-read.xlsx("C:/Users/Cássia/Desktop/SES/Bancos_brutos/SIMC_bruto_2024_atual.xlsx") #52009
ILTB_bruto<-read_excel("C:/Users/Cássia/Desktop/SES/Bancos_brutos/banco_bruto_ILTB.xlsx") #15.687
MUNICIPIOS<-read.xlsx("C:/Users/Cássia/Desktop/SES/Bancos_brutos/TABELA DE MUNICÍPIOS PDR 2026.xlsx") 
SINAN_TB_bruto<-read.dbf("C:/Users/Cássia/Desktop/SES/Bancos_brutos/TUBENET.dbf") #124033
MUNICIPIOS_POP<-read.xlsx("C:/Users/Cássia/Desktop/SES/Bancos_brutos/PDR2026_comPOP.xlsx") 
USUARIOS_BRUTO<-read_excel("C:/Users/Cássia/Desktop/SES/Bancos_brutos/Usuários_ILTB.xlsx")#3.170

#SES
SIMC_bruto<-read.xlsx("C:/Users/x3996631/Desktop/CÁSSIA/Bancos_brutos/SIMC_bruto_2025_atual.xlsx") #35299
ILTB_bruto<-read_excel("C:/Users/x3996631/Desktop/CÁSSIA/Bancos_brutos/banco_bruto_ILTB.xlsx") #15919
MUNICIPIOS<-read.xlsx("C:/Users/x3996631/Desktop/CÁSSIA/Bancos_brutos/TABELA DE MUNICÍPIOS PDR 2026.xlsx")
SINAN_TB_bruto<-read.dbf("C:/Users/x3996631/Desktop/CÁSSIA/Bancos_brutos/TUBENET.dbf") #127752
MUNICIPIOS_POP<-read.xlsx("C:/Users/x3996631/Desktop/CÁSSIA/Bancos_brutos/PDR2026_comPOP.xlsx") 
USUARIOS_BRUTO<-read_excel("C:/Users/x3996631/Desktop/CÁSSIA/Bancos_brutos/Usuários_ILTB.xlsx") #3178
...
#write.csv(ILTB,"C:/Users/Cássia/Desktop/SES/IL-TB/Painel/ILTB_TT_perfil.csv") 
#write.csv(ILTB,"C:/Users/x3996631/Desktop/CÁSSIA/IL-TB/Painel/ILTB_TT_perfil.csv")
...
## EXportação do banco para alimentação do painel ILTB nas páginas "Perfil da população" e "Quantitativos" 14.363 obs e 25 variables
#write.csv(ILTB_mapas,"C:/Users/Cássia/Desktop/SES/IL-TB/Painel/ILTB_mapa.csv") 
#write.csv(ILTB_mapas,"C:/Users/x3996631/Desktop/CÁSSIA/IL-TB/Painel/ILTB_mapa.csv")
...
#write.xlsx(ILTB_expirado,"C:/Users/Cássia/Desktop/SES/IL-TB/Monitoramento/CASOS_SEM_ENCERRAMENTOS.xlsx") 
#write.xlsx(ILTB_expirado,"C:/Users/x3996631/Desktop/CÁSSIA/IL-TB/Monitoramento/CASOS_SEM_ENCERRAMENTOS.xlsx") 
...
#write.xlsx(ILTB_duplicadas_final,"C:/Users/Cássia/Desktop/SES/IL-TB/Monitoramento/ILTB_duplicidades_reentradas.xlsx") 
#write.xlsx(ILTB_duplicadas_final,"C:/Users/x3996631/Desktop/CÁSSIA/IL-TB/Monitoramento/ILTB_duplicidades_reentradas.xlsx") 
...
##  EXPORTAÇÃO para alimentar a planilha MOT-ILTB - 682 obs e 11 variables
#write.xlsx(ILTB_3HP,"C:/Users/Cássia/Desktop/SES/TBC/Monitoramento_oportuno_TB/Bancos_tratados/Indicador_3HP.xlsx")
#write.xlsx(ILTB_3HP,"C:/Users/x3996631/Desktop/CÁSSIA/TBC/Monitoramento_oportuno_TB/Bancos_tratados/Indicador_3HP.xlsx")

## EXportação do banco para alimentação do painel ILTB
#write.csv(ILTB_3HP,"C:/Users/Cássia/Desktop/SES/IL-TB/Painel/ILTB_3HP.csv") 
#write.csv(ILTB_3HP,"C:/Users/x3996631/Desktop/CÁSSIA/IL-TB/Painel/ILTB_3HP.csv")
...
SIMC<- SIMC%>%
  mutate(Atendimento = case_when(
    Instituicao.solicitante %in% c("Ambulatório de Doenças Infecciosas e Parasitárias Ribeirão das Neves",
                                   ...
                                   "Universidade Federal do Triângulo Mineiro - Lab. de Uberaba #") ~ "Ambulatorial",
    Instituicao.solicitante %in% c("HOSPITAL DE PRONTO SOCORRO DOUTOR MOZART GERALDO TEIXEIRA",
                                   ...
                                   "Serviço Social Autônomo do Hospital Metropolitano Dr. Célio de Castro") ~ "Hospitalar",
    TRUE ~ "Ignorado"))
...
SIMC <- SIMC %>%
  mutate(Acao.realizada = case_when(
    Atendimento == "Ambulatorial" & Valor.do.CD4.na.ocasião <= 100 ~ "Realizar LF-LAM",
    Atendimento == "Hospitalar"    & Valor.do.CD4.na.ocasião <= 200 ~ "Realizar LF-LAM",
    Acao.realizada %in% c( "Indicado tratamento para ILTB","Indicado tratamento para TB","Iniciado tratamento da ILTB e notificado no IL-TB") ~ "Encaminhado para Tratamento TB ou ILTB",
    Acao.realizada %in% c ("Óbito","Óbito identificado automaticamente pelo sistema") ~"Òbito",
    Acao.realizada %in% c ("Pessoa já tratou ILTB no passado","Pessoa já tratou TB no passado") ~"Pessoa já tratou TB ou ILTB no passado",
    TRUE ~ Acao.realizada
  ))
...
#write.xlsx(SIMC_MOT,"C:/Users/Cássia/Desktop/SES/TBC/Monitoramento_oportuno_TB/Bancos_tratados/INDICARDOR_BUSCA_ATIVA.xlsx") 
#write.xlsx(SIMC_MOT,"C:/Users/x3996631/Desktop/CÁSSIA/TBC/Monitoramento_oportuno_TB/Bancos_tratados/INDICARDOR_BUSCA_ATIVA.xlsx")

## EXportação do banco para alimentação do painel ILTB
#write.csv(SIMC_Painel,"C:/Users/Cássia/Desktop/SES/IL-TB/Painel/ILTB_HIV.csv") 
#write.csv(SIMC_Painel,"C:/Users/x3996631/Desktop/CÁSSIA/IL-TB/Painel/ILTB_HIV.csv")
...
#write.xlsx(USUARIOS,"C:/Users/Cássia/Desktop/SES/TBC/Monitoramento_oportuno_TB/Bancos_tratados/Indicador_DESCENTRALIZAÇÃO.xlsx")
#write.xlsx(USUARIOS,"C:/Users/x3996631/Desktop/CÁSSIA/TBC/Monitoramento_oportuno_TB/Bancos_tratados/Indicador_DESCENTRALIZAÇÃO.xlsx")

## EXportação do banco para alimentação do painel ILTB
#write.csv(USUARIOS,"C:/Users/Cássia/Desktop/SES/IL-TB/Painel/ILTB_descentralizacao.csv") 
#write.csv(USUARIOS,"C:/Users/x3996631/Desktop/CÁSSIA/IL-TB/Painel/ILTB_descentralizacao.csv")



##############################################   FINAL - DAQUI PRA FRENTE SÃO MELHORIAS AS SEREM IMPLEMENTADAS  ###############################
...
#write.xlsx(ILTB_tt_contraindicados,"C:/Users/Cássia/Desktop/SES/Medicamentos/Tratamentos contraindicados/Tratamentos_ILTB_contraindicados.xlsx")
#write.xlsx(ILTB_tt_contraindicados,"C:/Users/x3996631/Desktop/CÁSSIA/Medicamentos/Tratamentos contraindicados/Tratamentos_ILTB_contraindicados.xlsx")
...
#write.xlsx(SIMC_MG,"C:/Users/Cássia/Desktop/SES/TBC/Site SIMC/BAncos_tratados/SIMC_MG.xlsx")
#write.xlsx(ILTB,"C:/Users/Cássia/Desktop/SES/TBC/Site SIMC/BAncos_tratados/ILTB_tratado.xlsx")
...
#USUARIOS<-read_excel("C:/Users/Cássia/Desktop/SES/Bancos_brutos/Usuários_ILTB.xlsx")
#INSTITUICOES<-read_excel("C:/Users/Cássia/Desktop/SES/Bancos_brutos/Instituições_ILTB.xlsx")
#MUNICIPIOS<-read.xlsx("C:/Users/Cássia/Desktop/SES/Bancos_brutos/MUNICIPIOS_POP.xlsx")
...
#write.xlsx(USUARIOS_INSTITUICAO_ILTB,"C:/Users/Cássia/Desktop/SES/IL-TB/Boletins/USUARIOS_INSTITUICAO_ILTB.xlsx") 
